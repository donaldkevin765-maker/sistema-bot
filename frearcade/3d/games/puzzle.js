...
return matched;}
function removeMatches(matched){for(var i=0;i<matched.length;i++){var c=matched[i];E.scene.remove(c);var idx=crystals.indexOf(c);if(idx>-1)crystals.splice(idx,1);}
var pts=matched.length*10*(1+combo*0.5);score+=Math.round(pts);combo++;}
