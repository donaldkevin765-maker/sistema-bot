...
if(best&&bestDist<2){best.userData.hit=true;if(bestDist<0.3){score+=300;combo++;E.burstParticles(best.position,LANE_COLORS[best.userData.lane],8,2);E.playBeep(800+combo*10,0.1,'sine',0.15);msg('PERFECT!',500);}else if(bestDist<0.8){score+=200;combo++;E.playBeep(600,0.1,'sine',0.1);msg('GOOD',400);}else if(bestDist<1.5){score+=100;combo=0;E.playBeep(400,0.1,'square',0.08);msg('OK',300);}else{combo=0;E.shakeScreen(0.1);}
